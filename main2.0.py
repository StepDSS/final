...
# It's recommended to set the 'OPENAI_API_KEY' environment variable for security reasons.
# In PyCharm, you can set this in Run > Edit Configurations > Environment variables.
...
def calculate_metrics(pnl_data):
    ...
    for item in pnl_data:
        try:
            ...
            amount = item.get('amount_month_usd', '').replace(',', '').strip()
...
def generate_report(metrics):
    """
    Generates a report with insights and recommendations based on analytical metrics.
